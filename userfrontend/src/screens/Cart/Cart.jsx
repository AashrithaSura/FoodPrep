...
const Cart = () => {
    ...
    const getDiscountAmount = () => {
        ...
        if (appliedPromo.type === 'discount') {
            return calculatedTotalAmount * (appliedPromo.value || 0);
        } else if (appliedPromo.type === 'fixed') {
            return appliedPromo.value || 0;
        }
        return 0;
    };
    ...
    // Show loading if food_list isn't loaded yet
    if (!food_list) {
